...
- (ReviewCoreData *)saveReviewToCoreDataWithObjectId:(NSString * _Nullable)objectId withSeller:(UserCoreData * _Nullable)seller withRating:(int)rating withReview:(NSString * _Nullable)review withDate:(NSDate *)date withManagedObjectContext:(NSManagedObjectContext * _Nullable)context;
